...
/**
 * @ngdoc directive
 * @name maApp.directive:pickadate
 * @description
 * # pickadate
 */
...
//         element.text('this is the pickadate directive');
//       }
//     };
//   });

  // pick-a-date (attribute)
angular.module('maApp').directive('pickADate', function () {
    return {
        restrict: "A",
        scope: {
            pickADate: '=',
...
angular.module('maApp').directive('pickATime', function () {
    return {
        restrict: "A",
        scope: {
            pickATime: '=',
